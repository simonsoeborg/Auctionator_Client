...
class AuctionRepository_impl(auctionPort: Int) : AuctionRepository {
    ...
    override suspend fun createAuction(aId : Int, userName : String, itemName : String, price : Int, endDate : String, endTime : String, imgURL : String) {
        auctionHandler.put(ActualField("create"),
            ActualField(aId), // Auction Id
